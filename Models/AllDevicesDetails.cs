namespace GsmArenaDataSucker.Models
{
    ...
    public partial class AllDeviceDetails
    {
        [JsonProperty("data")]
    ...
    public partial class AllDeviceDetails
    {
        public static AllDeviceDetails[] FromJson(string json) => JsonConvert.DeserializeObject<AllDeviceDetails[]>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this AllDeviceDetails[] self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
